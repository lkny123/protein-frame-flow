...
from data.mof_dataset import MOFDataset
from data.mof_dataloader import MOFDatamodule
from common.utils import PROJECT_ROOT
from models.flow_module_mof import FlowModule
...
class Experiment:
    ...
    def _setup_dataset(self):
        ...
        self._valid_dataset = MOFDataset(
            cache_path=os.path.join(self._data_cfg.cache_dir, 'val_mini.pt'),
            dataset_cfg=self._data_cfg,
            is_training=False
        )
...
@hydra.main(version_base=None, config_path=str(PROJECT_ROOT / "configs"), config_name="base_mof.yaml")

...
class Interpolant:
    ...
    def sample(
        ...
        for i, t_2 in enumerate(ts[1:]):
            ...
            # Run model
            trans_t_1, rotmats_t_1 = mof_traj[-1]
            if self._trans_cfg.corrupt:
            ...
            mof_traj.append((trans_t_2, rotmats_t_2))
            t_1 = t_2
        ...
        mof_traj.append((pred_trans_1, pred_rotmats_1))

        # Convert trajectories to coordinates
        mof_coords = []
        for trans, rotmats in mof_traj:
            ...
            mof_coords.append(coords)

        clean_mof_coords = []
        for trans, rotmats in clean_traj:
            coords = self._assemble_coords(
                local_coords.squeeze(),
                rotmats.squeeze(),
                trans.squeeze(),
            ...
            clean_mof_coords.append(coords)

        return mof_coords, clean_mof_coords